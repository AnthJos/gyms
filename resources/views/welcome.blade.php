                ...
                <div class="container"> 
                  ...
                  <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                      ...
                      <li><a class="page-scroll" href="#classes">Clases</a></li>
                      <li><a class="page-scroll" href="#features">Caracteristicas</a></li>
                      <li><a class="page-scroll" href="#review">Comentarios</a></li>
                      <li><a class="page-scroll" href="#pricing">Precios</a></li>
                      <li><a class="page-scroll" href="/client/iniciar-sesion">Espacio del cliente</a></li>
                ...
                <div class="container nopadding">
                  <div class="col-md-12">
                    <div class="hero-content text-center">
                      <h1 class="wow fadeInUp" data-wow-delay="0.1s">SALUD PODER FELICIDAD</h1>
                      <p class="wow fadeInUp" data-wow-delay="0.2s"> Traiga a la mesa estrategias de supervivencia de ganar-ganar para garantizar una dominación proactiva. </p>
                      <a href="#classes" class="btn btn-action wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Empezar</a> </div>
                  </div>
                </div>
              </div>
              <!-- Classes Section -->
